...
function repo_init(){
    core_repo_init({
      ...
      'storage-menu': '<table><tr><td><input id=number-of-entities min=1 step=any type=number><td>Entities'
        + '<tr><td><input id=extra-length step=any type=number><td>Extra Length'
        + '<tr><td><input id=fixed-length step=any type=number><td>Fixed Length'
        + '<tr><td><input id=length-multiplier step=any type=number><td>Length Multiplier'
        + '<tr><td><input id=line-width step=any type=number><td>Line Width'
